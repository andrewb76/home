...
export const projects: IProject[] = [
  ...
  //  1997
  {
    ...
    short: "TNU",
    title: {
      ru: "Обучение в университете Вернадского.",
      en: "",
    },
    description: {
      ru: `Обучение в Крымском национальном университете им В.И.Вернадского.
      Специалист на кафедре финансы и кредит экономического факультета`,
      en: `Taurida National V.I.Vernadsky University
      Master of Economics Faculty of Economics and Finance`,
    },
    techStack: [],
  ...
  {
    key: "ed_codecamp_front",
    country: "us",
    img: "ed_codecamp_front.png",
    url: "https://www.freecodecamp.com/andrewb76/front-end-certification",
    short: "CodeCamp FE",
    title: {
      ru: "Курс FE разработка",
      en: "Course FrontEnd Development",
    },
    description: {
      ru: `CodeCamp FrontEnd Development`,
      en: `CodeCamp FrontEnd Development`,
    },
  ...
  },
  {
    ...
    description: {
      ru: `MongoDB University M101JS: MongoDB for Node.js Developers`,
      en: `MongoDB University M101JS: MongoDB for Node.js Developers`,
    },
  ...
  {
    key: "ed_stepik_python",
    country: "ru",
    img: "ed_stepik_python.png",
  ...
  //  2002
  {
    ...
    description: {
      ru: `Внедрение системы складского учета и взаиморасчетов.
  ...
  },
  {
    key: "ed_codecamp_js",
    country: "us",
    img: "ed_codecamp_js.png",
    url: "https://freecodecamp.org/certification/andrewb76/javascript-algorithms-and-data-structures",
    short: "CodeCamp JS",
    title: {
      ru: "Курс JS Алгоритмы и Структуры Данных",
      en: "Course JS Algorithms and Data Structures",
    },
    description: {
      ru: `JavaScript Algorithms and Data Structures`,
  ...
  {
    key: "ed_codecamp_front_lib",
    country: "us",
    img: "ed_codecamp_front_lib.png",
    url: "https://freecodecamp.org/certification/andrewb76/front-end-development-libraries",
    short: "CodeCamp FE Lib",
    title: {
      ru: "Курс FE Библиотеки",
      en: "Course Front End Development Libraries",
    },
    description: {
      ru: `CodeCamp Front End Development Libraries`,
      en: `CodeCamp Front End Development Libraries`,
    },
